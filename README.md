...
This repository aims to centralise public documentation and support for the [tool verrou](https://github.com/edf-hpc/verrou).


The documentation for the last stable version Verrou is available as a dedicated [chapter in the
Valgrind manual](http://edf-hpc.github.io/verrou/vr-manual.html).

If you need the documentation of the master version of verrou, you need to build the documentation, as described in the README of the verrou repository.
